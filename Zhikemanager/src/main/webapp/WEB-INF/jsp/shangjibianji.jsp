    		...
    		<div class="row border-bottom white-bg" style="box-shadow: 0px 4px 13px -8px #5A5A5A;z-index: 102;">
				<nav class="navbar navbar-default nav-head navbar-static-top" role="navigation" style="margin-bottom: 0">
										<ul class="nav navbar-nav navbar-left navbar-form-custom" style="min-width:60%;">
													<li class="active"><a href="/index.php?m=business&a=index"><span class="fa fa-suitcase" style="display:inline"></span>&nbsp;&nbsp;商机</a></li>
											</ul>
...
<div class="wrapper wrapper-content animated fadeIn">
	    <form class="form-horizontal" id="form" role="form" action="/index.php?m=business&a=edit" method="post" enctype="multipart/form-data">
		<input type="hidden" name="refer_url" value="" />
		<input type="hidden" name="business_id" value="318" />
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="input-daterange input-group" style="height:35px;">
											<span class="input-group-addon" style="background-color:#ccc;text-align:left;">20171205-0318</span>
										</div>
									</div>
									<div class="col-md-2"></div>
								</div>
																		<div class="form-group">
											<label class="col-md-4 control-label">商机名：</label>
																							<div class="col-md-6">
													<input class="form-control required" name="name" value="M_20171205-0318" type="text"/>
												</div>
											...
											<label class="col-md-4 control-label">商机金额：</label>
																							<div class="col-md-6">
													<input class="form-control "  type="text" id="crm_cpzsqd" name="crm_cpzsqd"  value=""/><span id="crm_cpzsqdTip" style="float: left;line-height: 32px;margin-left: 5%;color:red;"></span>												</div>
											...
											<div class="col-md-6">
												<select name="status_type_id" id="type_id" class="form-control">
													<option value="1" selected>默认分组</option><option value="2" >商机类型2</option><option value="3" >商机类型1</option><option value="4" >新客户商机</option><option value="5" >老客户订货</option><option value="6" >项目1</option><option value="7" >商机状态</option><option value="8" >订单流程</option>	
												</select>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6">
												<select name="status_id" id="status_id" class="form-control" >
													<option value="2" >发盘</option><option value="3" >合同</option><option value="103" >联系客户</option><option value="106" selected>khas</option><option value="1" >询盘</option><option value="98" >中标收款</option><option value="104" >样品</option><option value="99" >项目失败</option><option value="100" >项目落地</option>												</select>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
																			<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="contacts_id" id="contacts_id" value="0" />
												<input class="form-control " aria-required="true" placeholder="请点击选择" type="text" name="contacts_name" value="" id="contacts_name" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"></div>
										</div>
										<div class="form-group">
											<label class="col-md-4 control-label">商机金额：</label>
											<div class="col-md-6">
												<input class="form-control" type="text" name="final_price" id="business_price" value="500.00" placeholder="0.00" onblur="bu(this)" onkeyup="final_price_sum('business_price');"/>
											</div>
											<div class="col-md-2"></div>
										</div>
																			<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="customer_id" id="customer_id" value="320" />
												<input class="form-control required" aria-required="true" placeholder="请点击选择"  type="text" name="customer_name" id="customer_name" value="武帝时代" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
																			<div class="form-group">
											<label class="col-md-4 control-label">下次联系时间：</label>
																							<div class="col-md-6">
													<input class="form-control Wdate" input_type="time" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="nextstep_time" id="nextstep_time" type="text" value=""/><span id="nextstep_timeTip" style="float: left;line-height: 32px;margin-left: 5%;color:red;"></span>												</div>
																									<div class="col-md-2"></div>										</div>										<div class="form-group">
											<label class="col-md-4 control-label">成交几率：</label>
																							<div class="col-md-6">
									...
									<thead class="product_thead">
										<tr style="background-color:#FFFFFF;text-align:center;">
											...
											<tr id="row_1">
													...
													<td>
														<input type="hidden" name="business[product][1][product_id]" id="product_id_1" class="cproduct_id" value="84"/>
														<input type="text" class="form-control" id="product_name_1" style="border:none !important;" readonly="true" value="3-溴-5-胺基苯甲酸" title="3-溴-5-胺基苯甲酸"/>
													</td>
													<!-- <td>
														<span id="category_name_1" style="display:inline-block;min-width:50px;text-align:center;"></span>
													</td> -->
													<td>
														<!-- 原价 -->
														<input type="text" id="product_ori_price_1" name="business[product][1][ori_price]" class="form-control" style="border:none;!important" readonly="readonly"  value="6500.00" />
													</td>
													<td>
														<!-- 折率 -->
														<input type="text" name="business[product][1][discount_rate]" id="product_discount_rate_1" style="" class="form-control" onkeyup="calculate(1,1)" placeholder="0.00" value="25.00"/>
													</td>
													<td>
														<input type="text" class="form-control" name="business[product][1][unit_price]" id="product_unit_price_1" onkeyup="calculate(1)" style="" value="4875.00" />
													</td>
													<td>
														<!-- 商品数量 -->
														<input type="text" class="form-control amount" name="business[product][1][amount]" style="" id="product_amount_1" onkeyup="calculate(1)" value="1"/>
													</td>
													<td>
														<input type="text" style="border:none;!important" name="business[product][1][unit]" readonly="readonly" class="form-control" value="瓶"/>
													</td>
													<td>
														<!-- 小计 -->
														<input type="text" style="border:none;!important" name="business[product][1][subtotal]" id="product_subtotal_1" class="form-control subtotal" value="4875.00" readonly="readonly" rel="1"/>
													</td>
												</tr>
												<tr id="row_2">
													<td style="text-align:center;">
													...
													<td>
														<input type="hidden" name="business[product][2][product_id]" id="product_id_2" class="cproduct_id" value="86"/>
														<input type="text" class="form-control" id="product_name_2" style="border:none !important;" readonly="true" value="真金" title="真金"/>
													</td>
													<!-- <td>
														<span id="category_name_2" style="display:inline-block;min-width:50px;text-align:center;"></span>
													</td> -->
													<td>
														<!-- 原价 -->
														<input type="text" id="product_ori_price_2" name="business[product][2][ori_price]" class="form-control" style="border:none;!important" readonly="readonly"  value="522230.02" />
													</td>
													<td>
														<!-- 折率 -->
														<input type="text" name="business[product][2][discount_rate]" id="product_discount_rate_2" style="" class="form-control" onkeyup="calculate(2,1)" placeholder="0.00" value="20.00"/>
													</td>
													<td>
														<input type="text" class="form-control" name="business[product][2][unit_price]" id="product_unit_price_2" onkeyup="calculate(2)" style="" value="417784.02" />
													</td>
													<td>
														<!-- 商品数量 -->
														<input type="text" class="form-control amount" name="business[product][2][amount]" style="" id="product_amount_2" onkeyup="calculate(2)" value="1"/>
													</td>
													<td>
														<input type="text" style="border:none;!important" name="business[product][2][unit]" readonly="readonly" class="form-control" value="个"/>
													</td>
													<td>
														<!-- 小计 -->
														<input type="text" style="border:none;!important" name="business[product][2][subtotal]" id="product_subtotal_2" class="form-control subtotal" value="417784.02" readonly="readonly" rel="2"/>
													</td>
												</tr>
																						</tbody>
								...
								<div class="ibox" style="overflow-x: hidden;margin: 10px 5px 0px;">
									<div class="row" style="margin: 10px 5px 0px;">
										<div class="col-md-4" style="padding-top:9px">
											产品合计(元):&nbsp; 
											<span id="total_subtotal_val">422659.02</span>
											<input type="hidden" value="422659.02" name="total_subtotal_val">
										</div>
										<div class="col-md-3">整单折扣(%):&nbsp;
											<input style="display: inline-block; width: 48px; padding: 1px;" type="text" id="final_discount_rate" name="final_discount_rate" class="form-control" onkeyup="final_price_sum('rate');" value="0.00"/>
										</div>
										<div class="col-md-5" >销售订单金额(元):&nbsp;
											<input style="display: inline-block; width: 100px; padding: 1px;" type="text" name="" id="final_price" class="form-control" placeholder="0.00" onkeyup="final_price_sum('price');" value="500.00" onblur="bu(this)" />
											<input type="hidden" id="total_amount_val" value="2" name="total_amount">
										</div>
									</div>
								</div>
							</div>
...
<div style="display:none" id="dialog-validate" title="商机名验重结果">
	有以下商机与该商机名类似	<div id="search_content"></div>
</div>
<script type="text/javascript">
...
$(function(){
	$('#name').blur(function(){
		name = $('#name').val();
		if(name!=''){
			$.post('/index.php?m=business&a=check',
				{
					name:name
				},
				function(data){
	...
	$('#contacts_name').click(function () {
		...
		$('#dialog-contacts-list').load("/index.php?m=contacts&a=radiolistdialog&id="+customer_id);
	});
...
<!-- nice-scroll -->
<script src="/Public/style/js/plugins/nice-scroll/jquery.nicescroll.min.js" type="text/javascript"></script>
<style>
    .left_chat-message{
        float:left;
        max-width: 90%;
