    		...
    		<div class="row border-bottom white-bg" style="box-shadow: 0px 4px 13px -8px #5A5A5A;z-index: 102;">
				<nav class="navbar navbar-default nav-head navbar-static-top" role="navigation" style="margin-bottom: 0">
										<ul class="nav navbar-nav navbar-left navbar-form-custom" style="min-width:60%;">
													<li class="active"><a href="http://demo2.5kcrm.net/index.php?m=user&amp;a=contacts"><span class="fa fa-phone-square" style="display:inline"></span>&nbsp;&nbsp;通讯录</a></li>
											</ul>
					<ul class="nav navbar-top-links navbar-right" style="margin-right:0px;">
		                    ...
		                    <a class="dropdown-toggle count-info" id="todo_url" data-toggle="dropdown" href="#" title="待办事项">
		                        <img src="img/remain.png" alt=""><div class="label label-info" style="background-color: #FA7252;" id="todo_num">224</div>
		                    </a>
	                   		<ul class="dropdown-menu dropdown-alerts folder-list m-b-md" style="width:250px;">
																									...
																									<li style="border-bottom:1px dashed #e7eaec !important;"><a href="http://demo2.5kcrm.net/index.php?m=contract&amp;a=index&amp;by=dqcontact"><i class="fa fa-user"></i>&nbsp;&nbsp;合同到期提醒<span class="label label-info pull-right" style="background-color: #FA7252;" id="header_dqcontact_num">42</span></a></li>
		                ...
		                <li class="dropdown">
	                    	...
	                    	<ul class="dropdown-menu dropdown-alerts" style="width:365px;">
	                    		<li class="list-group" role="presentation" id="message_group" style="height: 220px;">
	                        		<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="full-height-scroll" id="message_list" data-height="220px" data-plugin="slimScroll" style="overflow: hidden; width: auto; height: 100%;"><a href="http://demo2.5kcrm.net/index.php?m=message&amp;a=index" style="width:100%;color:#676a6c;padding:5px !important;border-bottom:1px dashed #ddd;float:left;margin-bottom:5px;">		                    <div style="padding:0 10px;">		                        <img src="img/wukong.png" title="悟空小助手"> 您有<strong>23</strong>条消息待查看		                        <span class="pull-right text-muted small" style="line-height:30px;">2分钟49秒前</span>		                    </div>		                </a></div><div class="slimScrollBar" style="background: rgb(153, 153, 153) none repeat scroll 0% 0%; width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; opacity: 0.2; z-index: 90; right: 1px;"></div></div>
	                        	</li>
	                    		<li>
			                        <div class="text-center link-block">
...
<link type="text/css" href="css/dynamic.css" rel="stylesheet">
				...
				<div class="ibox-content">
					...
					<div class="pull-right">
						<p style="font-size: 14px;">
							<a class="btn btn-primary btn-sm" href="http://demo2.5kcrm.net/index.php?m=user&amp;a=edit&amp;id=2">编辑</a>
							<a class="btn btn-primary btn-sm" href="javascript:void(0)" onclick="javascript:history.go(-1)">返回</a>
						</p>
					</div>
					<div class="row">
						<div class="col-sm-12">
								...
								<div class="tab-pane active" id="tab1">
									<table class="table" width="95%" border="0" cellspacing="1" cellpadding="0">
										<tbody>
											...
											<tr>
												<td class="tdleft">用户头像</td>
												<td>
													<a href="http://demo2.5kcrm.net/Uploads/head/5966dec13c7666466.png" class="litebox">
															<img src="img/5966dec13c7666466.png" style="height:70px;width:70px;margin-bottom: 0px;" class="thumbnail img">
														</a>
																									</td>
											...
											<tr>
												<td class="tdleft" width="15%">用户名 :</td>
												<td width="35%">
													李鸿雁(
													员工)
												</td>
																								<td class="tdleft" width="15%">目前职位： </td><td width="35%">行政部-行政经理</td>
											</tr>
											<tr>
											...
											<tr>
												<td class="tdleft">手机 :</td><td><a href="tel:15589745215">15589745215</a></td>
																								<td class="tdleft">办公电话 :</td>
												<td><a href="tel:"></a></td>
											</tr>
											<tr>
																								<td class="tdleft">邮箱 :</td>
												<td><a href="mailto:17895412568@qq.com">17895412568@qq.com</a></td>
