...
<div class="wrapper wrapper-content animated fadeIn">
		<form class="form-horizontal" id="form" role="form" action="/index.php?m=contract&a=edit" method="post" enctype="multipart/form-data">
		<input type="hidden" name="contract_id" id="contract_id" value="254">
		<input type="hidden" name="total_amount_val" id="total_amount" value="1">
		<input type="hidden" name="sales_id" value="241" />
						...
						<div class="row" >
							...
							<div class="col-md-11 add_body_form" style="margin:20px 0 0 13px;">
									...
									<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="customer_id" id="customer_id" value="433" />
												<input class="form-control required" aria-required="true" placeholder="请点击选择" type="text" name="customer_name" id="customer_name" value="展览会" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"><span style="color:red">*</span></div>
										</div>
																														<div class="form-group">
												...
												<div class="col-md-6">
													<input type="hidden" name="business_id" id="business_id" value="408"/>
													<input class="form-control" placeholder="请点击选择"  type="text" name="business_name" id="business_name" value="M_20180124-0408" readonly="true" style="cursor:pointer;" title="请点击选择"/>
												</div>
												<div class="col-md-2"></div>
											</div>																			<div class="form-group">
											<label class="col-md-4 control-label">合同金额(元)：</label>
											<div class="col-md-6">
												<input class="form-control required" type="text" id="contract_price" name="price" value="2121.00" onblur="bu(this)" onkeyup="final_price_sum('contract_price');"/>
											</div>
											<div class="col-md-2"><span style="color:red">*</span></div>
										</div>
																			<div class="form-group">
											<label class="col-md-4 control-label">签约时间：</label>
																							<div class="col-md-6">
													<input class="form-control Wdate" input_type="time" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="due_time" id="due_time" type="text" value="2018-01-24"/><span id="due_timeTip" style="float: left;line-height: 32px;margin-left: 5%;color:red;"></span>												</div>
											...
											<div class="col-md-6">
												<input class="form-control required Wdate" aria-required="true" type="text" id="start_date" name="start_date" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:&quot;#F{$dp.$D('end_date')||'2038-01-01'}&quot;})" value="2018-01-24" />
											</div>
											<div class="col-md-2"><span style="color:red">*</span></div>
										</div>
																			<div class="form-group">
											...
											<div class="col-md-6">
												<input class="form-control required Wdate" aria-required="true" type="text" id="end_date" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:&quot;#F{$dp.$D('start_date')}&quot;,maxDate:'2038-01-01'})" value="2018-01-27" name="end_date" />
											</div>
											<div class="col-md-2"><span style="color:red">*</span></div>
										</div>
																			<div class="form-group">
											<label class="col-md-4 control-label">合同描述：</label>
																								<div class="col-md-8">
														<textarea rows="5" class="form-control " id="description" name="description" >内容</textarea><span id="descriptionTip" style="float: left;line-height: 32px;margin-left: 5%;color:red;"></span>													</div>																					</div>							</div>
										...
										<tr style="background-color:#FFFFFF;text-align:center;">
											...
											<tr id="row_1">
													<td style="text-align:center;">
														...
														<input type="hidden" name="business[product][1][sales_product_id]" value="307" />
													</td>
													<td>
														<input type="hidden" name="business[product][1][product_id]" id="product_id_1" class="cproduct_id" value="81"/>
														<input type="text" class="form-control" id="product_name_1" style="border:none !important;" readonly="true" value="121" title="121"/>
													</td>
													<td><!-- 原价 -->
														<input type="text" id="product_ori_price_1" class="form-control" style="border:none;!important" readonly="readonly"  value="2121.00" />
													</td>
													<td><!-- 折率 -->
														<input type="text" name="business[product][1][discount_rate]" id="product_discount_rate_1" style="" class="form-control" onkeyup="calculate(1,1)" value="0.00"/>
													</td>
													<td>
														<input type="text" class="form-control" name="business[product][1][unit_price]" id="product_unit_price_1" onkeyup="calculate(1)" style="" value="2121.00" />
													</td>
													<td><!-- 商品数量 -->
													...
													<td>
														<input type="text" style="border:none;!important" name="business[product][1][unit]" readonly="readonly" class="form-control" value="箱"/>
													</td>
													<td><!-- 小计 -->
														<input type="text" style="border:none;!important" name="business[product][1][subtotal]" id="product_subtotal_1" class="form-control subtotal" value="2121.00" readonly="readonly" rel="1"/>
													</td>
												</tr>
																						</tbody>
								...
								<div class="ibox" style="overflow-x: hidden;margin: 10px 5px 0px;">
									<div class="row" style="margin: 10px 5px 0px;">
										<div class="col-md-4" style="padding-top:9px">
											产品合计(元):&nbsp; 
											<span id="total_subtotal_val">2121.00</span>
											<input type="hidden" value="2121.00" id="prime_price" name="prime_price">
										</div>
										<div class="col-md-4">整单折扣(%):&nbsp;
											<input style="display: inline-block; width: 60px; padding: 1px;" type="text" id="final_discount_rate" name="final_discount_rate" class="form-control" onkeyup="final_price_sum('rate');"value="0.00"/>
										</div>
										<div class="col-md-4">合同金额(元):&nbsp;
											<input style="display: inline-block; width: 100px; padding: 1px;" type="text" name="final_price" id="final_price" class="form-control" placeholder="0.00" onkeyup="final_price_sum('price');" value="2121.00" onblur="bu(this)" />
...
// 固定按钮
		...
		var t_type = "contract";
			...
			list += "<li class='($vo['type']}'>"+t_name+"<a href='/index.php?m=contract&a=view&id=254'>展览</a></li>";var t_type = "contract";
			var t_name = '';
			if(t_type == "leads"){
				t_name = '<i>线</i>';
			}
			...
			list += "<li class='($vo['type']}'>"+t_name+"<a href='/index.php?m=contract&a=view&id=297'>的撒旦</a></li>";var t_type = "contract";
			var t_name = '';
			if(t_type == "leads"){
				t_name = '<i>线</i>';
			}
...
<script src="/Public/js/animate/index.js"></script>
<script src="/Public/js/animate/notification.js"></script>
<!-- layer -->
<script src="/Public/js/layer/layer.js"></script>
<script src="/Public/js/call/call.js"></script>
<script type='text/javascript'>
